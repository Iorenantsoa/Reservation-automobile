...
const AccueilMaReservation = () => {
    return (
        <div className='container-fluid mb-5 d-flex flex-column align-items-center justify-content-center shadow' style={{ backgroundColor: "rgb(206,221,55)", minHeight: "45vh" }}>
